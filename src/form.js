...
function handleForm(id) {
	...
	document.getElementById("signUp__btn").addEventListener("click", (e) => {
		...
		form.querySelector("input[name=name]").classList.toggle("signUp__hidden"); 
		form.querySelector("input[name=surname]").classList.toggle("signUp__hidden");
		form.querySelector("input[name=email]").classList.toggle("signUp__hidden");
